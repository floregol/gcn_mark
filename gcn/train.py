...
# def get_trained_gcn(seed, QUICK_MODE=False):
#     os.environ['TF_CPP_MIN_LOG_LEVEL'] = '6'
#     # Set random seed
#     seed = seed
#     np.random.seed(seed)
...
#     return w_0, w_1, A_tilde, FLAGS, softmax, adj, initial_features, y_train, y_val, y_test, train_mask, val_mask, test_mask, labels